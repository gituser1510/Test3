            ...
            try
            {
                ...
                do
                {
                    ...
                    catch (Exception exx)
                    {
                        ...
                        {
                            MessageBox.Show("Some unexpected error occurred \r\n" + eeex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            break; // TODO: might not be correct. Was : Exit Do
                ...
                {
                    MessageBox.Show("File is not valid", "Invalid", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                else
                {
                    MessageBox.Show("File is valid", "Valid", MessageBoxButtons.OK, MessageBoxIcon.Information);
